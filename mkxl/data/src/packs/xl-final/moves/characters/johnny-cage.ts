...
export const johnnyCageMoves = {
  sourcePath: "characters/johnny-cage.ts",
  characterId,
  ...
  variations: {
    aList: {
      aListTechnique: {
        id: `${characterId}:a-list:a-list-technique`,
        characterId,
        label: {
          EN: "A-List Technique",
          fallback: "A-List Technique",
        },
        notation: [fgcNotation.down, fgcNotation.back, fgcNotation.one],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:a-list`],
        },
    ...
    fisticuffs: {
      fisticuffsTechnique: {
        id: `${characterId}:fisticuffs:fisticuffs-technique`,
        characterId,
        label: {
          EN: "Fisticuffs Technique",
          fallback: "Fisticuffs Technique",
        },
        notation: [fgcNotation.back, fgcNotation.forward, fgcNotation.two],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:fisticuffs`],
        },
        tags: ["variation", "branch-specific"],
        sourceIds: ["mkwarehouse-mkx", "in-game-practice-mode"],
      },
    ...
    stuntDouble: {
      stuntDoubleTechnique: {
        id: `${characterId}:stunt-double:stunt-double-technique`,
        characterId,
        label: {
          EN: "Stunt Double Technique",
          fallback: "Stunt Double Technique",
        },
        notation: [fgcNotation.down, fgcNotation.forward, fgcNotation.three],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:stunt-double`],
        },
        meterGain: 1,
        tags: ["variation", "branch-specific"],
        sourceIds: ["mkwarehouse-mkx", "in-game-practice-mode"],
