...
export const sonyaBladeMoves = {
  sourcePath: "characters/sonya-blade.ts",
  characterId,
  ...
  variations: {
    covertOps: {
      covertOpsTechnique: {
        id: `${characterId}:covert-ops:covert-ops-technique`,
        characterId,
        label: {
          EN: "Covert Ops Technique",
          fallback: "Covert Ops Technique",
        },
        notation: [fgcNotation.down, fgcNotation.back, fgcNotation.one],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:covert-ops`],
        },
    ...
    specialForces: {
      specialForcesTechnique: {
        id: `${characterId}:special-forces:special-forces-technique`,
        characterId,
        label: {
          EN: "Special Forces Technique",
          fallback: "Special Forces Technique",
        },
        notation: [fgcNotation.back, fgcNotation.forward, fgcNotation.two],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:special-forces`],
        },
        tags: ["variation", "branch-specific"],
        sourceIds: ["mkwarehouse-mkx", "in-game-practice-mode"],
      },
    ...
    demolition: {
      demolitionTechnique: {
        id: `${characterId}:demolition:demolition-technique`,
        characterId,
        label: {
          EN: "Demolition Technique",
          fallback: "Demolition Technique",
        },
        notation: [fgcNotation.down, fgcNotation.forward, fgcNotation.three],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:demolition`],
        },
        meterGain: 1,
        tags: ["variation", "branch-specific"],
        sourceIds: ["mkwarehouse-mkx", "in-game-practice-mode"],
