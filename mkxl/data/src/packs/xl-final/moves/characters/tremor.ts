...
export const tremorMoves = {
  sourcePath: "characters/tremor.ts",
  characterId,
  ...
  variations: {
    crystalline: {
      crystallineTechnique: {
        id: `${characterId}:crystalline:crystalline-technique`,
        characterId,
        label: {
          EN: "Crystalline Technique",
          fallback: "Crystalline Technique",
        },
        notation: [fgcNotation.down, fgcNotation.back, fgcNotation.one],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:crystalline`],
        },
    ...
    aftershock: {
      aftershockTechnique: {
        id: `${characterId}:aftershock:aftershock-technique`,
        characterId,
        label: {
          EN: "Aftershock Technique",
          fallback: "Aftershock Technique",
        },
        notation: [fgcNotation.back, fgcNotation.forward, fgcNotation.two],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:aftershock`],
        },
        tags: ["variation", "branch-specific"],
        sourceIds: ["mkwarehouse-mkx", "in-game-practice-mode"],
      },
    ...
    metallic: {
      metallicTechnique: {
        id: `${characterId}:metallic:metallic-technique`,
        characterId,
        label: {
          EN: "Metallic Technique",
          fallback: "Metallic Technique",
        },
        notation: [fgcNotation.down, fgcNotation.forward, fgcNotation.three],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:metallic`],
        },
        meterGain: 1,
        tags: ["variation", "branch-specific"],
        sourceIds: ["mkwarehouse-mkx", "in-game-practice-mode"],
