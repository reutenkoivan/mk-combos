...
export const kotalKahnMoves = {
  sourcePath: "characters/kotal-kahn.ts",
  characterId,
  ...
  variations: {
    sunGod: {
      sunGodTechnique: {
        id: `${characterId}:sun-god:sun-god-technique`,
        characterId,
        label: {
          EN: "Sun God Technique",
          fallback: "Sun God Technique",
        },
        notation: [fgcNotation.down, fgcNotation.back, fgcNotation.one],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:sun-god`],
        },
    ...
    bloodGod: {
      bloodGodTechnique: {
        id: `${characterId}:blood-god:blood-god-technique`,
        characterId,
        label: {
          EN: "Blood God Technique",
          fallback: "Blood God Technique",
        },
        notation: [fgcNotation.back, fgcNotation.forward, fgcNotation.two],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:blood-god`],
        },
        tags: ["variation", "branch-specific"],
        sourceIds: ["mkwarehouse-mkx", "in-game-practice-mode"],
      },
    ...
    warGod: {
      warGodTechnique: {
        id: `${characterId}:war-god:war-god-technique`,
        characterId,
        label: {
          EN: "War God Technique",
          fallback: "War God Technique",
        },
        notation: [fgcNotation.down, fgcNotation.forward, fgcNotation.three],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:war-god`],
        },
        meterGain: 1,
        tags: ["variation", "branch-specific"],
        sourceIds: ["mkwarehouse-mkx", "in-game-practice-mode"],
