...
export const triborgMoves = {
  sourcePath: "characters/triborg.ts",
  characterId,
  ...
  variations: {
    smoke: {
      smokeTechnique: {
        id: `${characterId}:smoke:smoke-technique`,
        characterId,
        label: {
          EN: "Smoke Technique",
          fallback: "Smoke Technique",
        },
        notation: [fgcNotation.down, fgcNotation.back, fgcNotation.one],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:smoke`],
        },
    ...
    sektor: {
      sektorTechnique: {
        id: `${characterId}:sektor:sektor-technique`,
        characterId,
        label: {
          EN: "Sektor Technique",
          fallback: "Sektor Technique",
        },
        notation: [fgcNotation.back, fgcNotation.forward, fgcNotation.two],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:sektor`],
        },
        tags: ["variation", "branch-specific"],
        sourceIds: ["mkwarehouse-mkx", "in-game-practice-mode"],
      },
    ...
    cyrax: {
      cyraxTechnique: {
        id: `${characterId}:cyrax:cyrax-technique`,
        characterId,
        label: {
          EN: "Cyrax Technique",
          fallback: "Cyrax Technique",
        },
        notation: [fgcNotation.down, fgcNotation.forward, fgcNotation.three],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:cyrax`],
        },
        meterGain: 1,
        tags: ["variation", "branch-specific"],
        sourceIds: ["mkwarehouse-mkx", "in-game-practice-mode"],
    ...
    cyberSubZero: {
      cyberSubZeroTechnique: {
        id: `${characterId}:cyber-sub-zero:cyber-sub-zero-technique`,
        characterId,
        label: {
          EN: "Cyber Sub-Zero Technique",
          fallback: "Cyber Sub-Zero Technique",
        },
        notation: [fgcNotation.down, fgcNotation.forward, fgcNotation.three],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:cyber-sub-zero`],
        },
        tags: ["variation", "branch-specific"],
        sourceIds: ["mkwarehouse-mkx", "in-game-practice-mode"],
      },
