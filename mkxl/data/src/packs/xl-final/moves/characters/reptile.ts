...
export const reptileMoves = {
  sourcePath: "characters/reptile.ts",
  characterId,
  ...
  variations: {
    noxious: {
      noxiousTechnique: {
        id: `${characterId}:noxious:noxious-technique`,
        characterId,
        label: {
          EN: "Noxious Technique",
          fallback: "Noxious Technique",
        },
        notation: [fgcNotation.down, fgcNotation.back, fgcNotation.one],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:noxious`],
        },
    ...
    deceptive: {
      deceptiveTechnique: {
        id: `${characterId}:deceptive:deceptive-technique`,
        characterId,
        label: {
          EN: "Deceptive Technique",
          fallback: "Deceptive Technique",
        },
        notation: [fgcNotation.back, fgcNotation.forward, fgcNotation.two],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:deceptive`],
        },
        tags: ["variation", "branch-specific"],
        sourceIds: ["mkwarehouse-mkx", "in-game-practice-mode"],
      },
    ...
    nimble: {
      nimbleTechnique: {
        id: `${characterId}:nimble:nimble-technique`,
        characterId,
        label: {
          EN: "Nimble Technique",
          fallback: "Nimble Technique",
        },
        notation: [fgcNotation.down, fgcNotation.forward, fgcNotation.three],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:nimble`],
        },
        meterGain: 1,
        tags: ["variation", "branch-specific"],
        sourceIds: ["mkwarehouse-mkx", "in-game-practice-mode"],
