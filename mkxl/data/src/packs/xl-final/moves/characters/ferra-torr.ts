...
export const ferraTorrMoves = {
  sourcePath: "characters/ferra-torr.ts",
  characterId,
  ...
  variations: {
    lackey: {
      lackeyTechnique: {
        id: `${characterId}:lackey:lackey-technique`,
        characterId,
        label: {
          EN: "Lackey Technique",
          fallback: "Lackey Technique",
        },
        notation: [fgcNotation.down, fgcNotation.back, fgcNotation.one],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:lackey`],
        },
    ...
    ruthless: {
      ruthlessTechnique: {
        id: `${characterId}:ruthless:ruthless-technique`,
        characterId,
        label: {
          EN: "Ruthless Technique",
          fallback: "Ruthless Technique",
        },
        notation: [fgcNotation.back, fgcNotation.forward, fgcNotation.two],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:ruthless`],
        },
        tags: ["variation", "branch-specific"],
        sourceIds: ["mkwarehouse-mkx", "in-game-practice-mode"],
      },
    ...
    vicious: {
      viciousTechnique: {
        id: `${characterId}:vicious:vicious-technique`,
        characterId,
        label: {
          EN: "Vicious Technique",
          fallback: "Vicious Technique",
        },
        notation: [fgcNotation.down, fgcNotation.forward, fgcNotation.three],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:vicious`],
        },
        meterGain: 1,
        tags: ["variation", "branch-specific"],
        sourceIds: ["mkwarehouse-mkx", "in-game-practice-mode"],
