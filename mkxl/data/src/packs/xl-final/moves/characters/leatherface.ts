...
export const leatherfaceMoves = {
  sourcePath: "characters/leatherface.ts",
  characterId,
  ...
  variations: {
    prettyLady: {
      prettyLadyTechnique: {
        id: `${characterId}:pretty-lady:pretty-lady-technique`,
        characterId,
        label: {
          EN: "Pretty Lady Technique",
          fallback: "Pretty Lady Technique",
        },
        notation: [fgcNotation.down, fgcNotation.back, fgcNotation.one],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:pretty-lady`],
        },
    ...
    killer: {
      killerTechnique: {
        id: `${characterId}:killer:killer-technique`,
        characterId,
        label: {
          EN: "Killer Technique",
          fallback: "Killer Technique",
        },
        notation: [fgcNotation.back, fgcNotation.forward, fgcNotation.two],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:killer`],
        },
        tags: ["variation", "branch-specific"],
        sourceIds: ["mkwarehouse-mkx", "in-game-practice-mode"],
      },
    ...
    butcher: {
      butcherTechnique: {
        id: `${characterId}:butcher:butcher-technique`,
        characterId,
        label: {
          EN: "Butcher Technique",
          fallback: "Butcher Technique",
        },
        notation: [fgcNotation.down, fgcNotation.forward, fgcNotation.three],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:butcher`],
        },
        meterGain: 1,
        tags: ["variation", "branch-specific"],
        sourceIds: ["mkwarehouse-mkx", "in-game-practice-mode"],
