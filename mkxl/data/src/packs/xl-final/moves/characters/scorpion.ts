...
export const scorpionMoves = {
  sourcePath: "characters/scorpion.ts",
  characterId,
  ...
  variations: {
    inferno: {
      infernoTechnique: {
        id: `${characterId}:inferno:inferno-technique`,
        characterId,
        label: {
          EN: "Inferno Technique",
          fallback: "Inferno Technique",
        },
        notation: [fgcNotation.down, fgcNotation.back, fgcNotation.one],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:inferno`],
        },
    ...
    ninjutsu: {
      ninjutsuTechnique: {
        id: `${characterId}:ninjutsu:ninjutsu-technique`,
        characterId,
        label: {
          EN: "Ninjutsu Technique",
          fallback: "Ninjutsu Technique",
        },
        notation: [fgcNotation.back, fgcNotation.forward, fgcNotation.two],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:ninjutsu`],
        },
        tags: ["variation", "branch-specific"],
        sourceIds: ["mkwarehouse-mkx", "in-game-practice-mode"],
      },
    ...
    hellfire: {
      hellfireTechnique: {
        id: `${characterId}:hellfire:hellfire-technique`,
        characterId,
        label: {
          EN: "Hellfire Technique",
          fallback: "Hellfire Technique",
        },
        notation: [fgcNotation.down, fgcNotation.forward, fgcNotation.three],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:hellfire`],
        },
        meterGain: 1,
        tags: ["variation", "branch-specific"],
        sourceIds: ["mkwarehouse-mkx", "in-game-practice-mode"],
