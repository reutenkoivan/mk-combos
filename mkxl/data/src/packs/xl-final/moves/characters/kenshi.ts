...
export const kenshiMoves = {
  sourcePath: "characters/kenshi.ts",
  characterId,
  ...
  variations: {
    kenjutsu: {
      kenjutsuTechnique: {
        id: `${characterId}:kenjutsu:kenjutsu-technique`,
        characterId,
        label: {
          EN: "Kenjutsu Technique",
          fallback: "Kenjutsu Technique",
        },
        notation: [fgcNotation.down, fgcNotation.back, fgcNotation.one],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:kenjutsu`],
        },
    ...
    balanced: {
      balancedTechnique: {
        id: `${characterId}:balanced:balanced-technique`,
        characterId,
        label: {
          EN: "Balanced Technique",
          fallback: "Balanced Technique",
        },
        notation: [fgcNotation.back, fgcNotation.forward, fgcNotation.two],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:balanced`],
        },
        tags: ["variation", "branch-specific"],
        sourceIds: ["mkwarehouse-mkx", "in-game-practice-mode"],
      },
    ...
    possessed: {
      possessedTechnique: {
        id: `${characterId}:possessed:possessed-technique`,
        characterId,
        label: {
          EN: "Possessed Technique",
          fallback: "Possessed Technique",
        },
        notation: [fgcNotation.down, fgcNotation.forward, fgcNotation.three],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:possessed`],
        },
        meterGain: 1,
        tags: ["variation", "branch-specific"],
        sourceIds: ["mkwarehouse-mkx", "in-game-practice-mode"],
