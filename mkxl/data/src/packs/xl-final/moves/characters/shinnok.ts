...
export const shinnokMoves = {
  sourcePath: "characters/shinnok.ts",
  characterId,
  ...
  variations: {
    necromancer: {
      necromancerTechnique: {
        id: `${characterId}:necromancer:necromancer-technique`,
        characterId,
        label: {
          EN: "Necromancer Technique",
          fallback: "Necromancer Technique",
        },
        notation: [fgcNotation.down, fgcNotation.back, fgcNotation.one],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:necromancer`],
        },
    ...
    impostor: {
      impostorTechnique: {
        id: `${characterId}:impostor:impostor-technique`,
        characterId,
        label: {
          EN: "Impostor Technique",
          fallback: "Impostor Technique",
        },
        notation: [fgcNotation.back, fgcNotation.forward, fgcNotation.two],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:impostor`],
        },
        tags: ["variation", "branch-specific"],
        sourceIds: ["mkwarehouse-mkx", "in-game-practice-mode"],
      },
    ...
    boneShaper: {
      boneShaperTechnique: {
        id: `${characterId}:bone-shaper:bone-shaper-technique`,
        characterId,
        label: {
          EN: "Bone Shaper Technique",
          fallback: "Bone Shaper Technique",
        },
        notation: [fgcNotation.down, fgcNotation.forward, fgcNotation.three],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:bone-shaper`],
        },
        meterGain: 1,
        tags: ["variation", "branch-specific"],
        sourceIds: ["mkwarehouse-mkx", "in-game-practice-mode"],
