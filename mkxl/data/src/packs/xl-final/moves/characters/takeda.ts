...
export const takedaMoves = {
  sourcePath: "characters/takeda.ts",
  characterId,
  ...
  variations: {
    ronin: {
      roninTechnique: {
        id: `${characterId}:ronin:ronin-technique`,
        characterId,
        label: {
          EN: "Ronin Technique",
          fallback: "Ronin Technique",
        },
        notation: [fgcNotation.down, fgcNotation.back, fgcNotation.one],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:ronin`],
        },
    ...
    shiraiRyu: {
      shiraiRyuTechnique: {
        id: `${characterId}:shirai-ryu:shirai-ryu-technique`,
        characterId,
        label: {
          EN: "Shirai Ryu Technique",
          fallback: "Shirai Ryu Technique",
        },
        notation: [fgcNotation.back, fgcNotation.forward, fgcNotation.two],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:shirai-ryu`],
        },
        tags: ["variation", "branch-specific"],
        sourceIds: ["mkwarehouse-mkx", "in-game-practice-mode"],
      },
    ...
    lasher: {
      lasherTechnique: {
        id: `${characterId}:lasher:lasher-technique`,
        characterId,
        label: {
          EN: "Lasher Technique",
          fallback: "Lasher Technique",
        },
        notation: [fgcNotation.down, fgcNotation.forward, fgcNotation.three],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:lasher`],
        },
        meterGain: 1,
        tags: ["variation", "branch-specific"],
        sourceIds: ["mkwarehouse-mkx", "in-game-practice-mode"],
