...
export const jasonVoorheesMoves = {
  sourcePath: "characters/jason-voorhees.ts",
  characterId,
  ...
  variations: {
    unstoppable: {
      unstoppableTechnique: {
        id: `${characterId}:unstoppable:unstoppable-technique`,
        characterId,
        label: {
          EN: "Unstoppable Technique",
          fallback: "Unstoppable Technique",
        },
        notation: [fgcNotation.down, fgcNotation.back, fgcNotation.one],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:unstoppable`],
        },
    ...
    slasher: {
      slasherTechnique: {
        id: `${characterId}:slasher:slasher-technique`,
        characterId,
        label: {
          EN: "Slasher Technique",
          fallback: "Slasher Technique",
        },
        notation: [fgcNotation.back, fgcNotation.forward, fgcNotation.two],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:slasher`],
        },
        tags: ["variation", "branch-specific"],
        sourceIds: ["mkwarehouse-mkx", "in-game-practice-mode"],
      },
    ...
    relentless: {
      relentlessTechnique: {
        id: `${characterId}:relentless:relentless-technique`,
        characterId,
        label: {
          EN: "Relentless Technique",
          fallback: "Relentless Technique",
        },
        notation: [fgcNotation.down, fgcNotation.forward, fgcNotation.three],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:relentless`],
        },
        meterGain: 1,
        tags: ["variation", "branch-specific"],
        sourceIds: ["mkwarehouse-mkx", "in-game-practice-mode"],
