...
export const kungLaoMoves = {
  sourcePath: "characters/kung-lao.ts",
  characterId,
  ...
  variations: {
    hatTrick: {
      hatTrickTechnique: {
        id: `${characterId}:hat-trick:hat-trick-technique`,
        characterId,
        label: {
          EN: "Hat Trick Technique",
          fallback: "Hat Trick Technique",
        },
        notation: [fgcNotation.down, fgcNotation.back, fgcNotation.one],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:hat-trick`],
        },
    ...
    tempest: {
      tempestTechnique: {
        id: `${characterId}:tempest:tempest-technique`,
        characterId,
        label: {
          EN: "Tempest Technique",
          fallback: "Tempest Technique",
        },
        notation: [fgcNotation.back, fgcNotation.forward, fgcNotation.two],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:tempest`],
        },
        tags: ["variation", "branch-specific"],
        sourceIds: ["mkwarehouse-mkx", "in-game-practice-mode"],
      },
    ...
    buzzSaw: {
      buzzSawTechnique: {
        id: `${characterId}:buzz-saw:buzz-saw-technique`,
        characterId,
        label: {
          EN: "Buzz Saw Technique",
          fallback: "Buzz Saw Technique",
        },
        notation: [fgcNotation.down, fgcNotation.forward, fgcNotation.three],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:buzz-saw`],
        },
        meterGain: 1,
        tags: ["variation", "branch-specific"],
        sourceIds: ["mkwarehouse-mkx", "in-game-practice-mode"],
