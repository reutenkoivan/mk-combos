...
export const jacquiBriggsMoves = {
  sourcePath: "characters/jacqui-briggs.ts",
  characterId,
  ...
  variations: {
    highTech: {
      highTechTechnique: {
        id: `${characterId}:high-tech:high-tech-technique`,
        characterId,
        label: {
          EN: "High Tech Technique",
          fallback: "High Tech Technique",
        },
        notation: [fgcNotation.down, fgcNotation.back, fgcNotation.one],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:high-tech`],
        },
    ...
    shotgun: {
      shotgunTechnique: {
        id: `${characterId}:shotgun:shotgun-technique`,
        characterId,
        label: {
          EN: "Shotgun Technique",
          fallback: "Shotgun Technique",
        },
        notation: [fgcNotation.back, fgcNotation.forward, fgcNotation.two],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:shotgun`],
        },
        tags: ["variation", "branch-specific"],
        sourceIds: ["mkwarehouse-mkx", "in-game-practice-mode"],
      },
    ...
    fullAuto: {
      fullAutoTechnique: {
        id: `${characterId}:full-auto:full-auto-technique`,
        characterId,
        label: {
          EN: "Full Auto Technique",
          fallback: "Full Auto Technique",
        },
        notation: [fgcNotation.down, fgcNotation.forward, fgcNotation.three],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:full-auto`],
        },
        meterGain: 1,
        tags: ["variation", "branch-specific"],
        sourceIds: ["mkwarehouse-mkx", "in-game-practice-mode"],
