...
export const predatorMoves = {
  sourcePath: "characters/predator.ts",
  characterId,
  ...
  variations: {
    hishQuTen: {
      hishQuTenTechnique: {
        id: `${characterId}:hish-qu-ten:hish-qu-ten-technique`,
        characterId,
        label: {
          EN: "Hish-Qu-Ten Technique",
          fallback: "Hish-Qu-Ten Technique",
        },
        notation: [fgcNotation.down, fgcNotation.back, fgcNotation.one],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:hish-qu-ten`],
        },
    ...
    warrior: {
      warriorTechnique: {
        id: `${characterId}:warrior:warrior-technique`,
        characterId,
        label: {
          EN: "Warrior Technique",
          fallback: "Warrior Technique",
        },
        notation: [fgcNotation.back, fgcNotation.forward, fgcNotation.two],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:warrior`],
        },
        tags: ["variation", "branch-specific"],
        sourceIds: ["mkwarehouse-mkx", "in-game-practice-mode"],
      },
    ...
    hunter: {
      hunterTechnique: {
        id: `${characterId}:hunter:hunter-technique`,
        characterId,
        label: {
          EN: "Hunter Technique",
          fallback: "Hunter Technique",
        },
        notation: [fgcNotation.down, fgcNotation.forward, fgcNotation.three],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:hunter`],
        },
        meterGain: 1,
        tags: ["variation", "branch-specific"],
        sourceIds: ["mkwarehouse-mkx", "in-game-practice-mode"],
