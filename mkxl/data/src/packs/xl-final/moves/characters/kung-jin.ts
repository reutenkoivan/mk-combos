...
export const kungJinMoves = {
  sourcePath: "characters/kung-jin.ts",
  characterId,
  ...
  variations: {
    shaolin: {
      shaolinTechnique: {
        id: `${characterId}:shaolin:shaolin-technique`,
        characterId,
        label: {
          EN: "Shaolin Technique",
          fallback: "Shaolin Technique",
        },
        notation: [fgcNotation.down, fgcNotation.back, fgcNotation.one],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:shaolin`],
        },
    ...
    ancestral: {
      ancestralTechnique: {
        id: `${characterId}:ancestral:ancestral-technique`,
        characterId,
        label: {
          EN: "Ancestral Technique",
          fallback: "Ancestral Technique",
        },
        notation: [fgcNotation.back, fgcNotation.forward, fgcNotation.two],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:ancestral`],
        },
        tags: ["variation", "branch-specific"],
        sourceIds: ["mkwarehouse-mkx", "in-game-practice-mode"],
      },
    ...
    bojutsu: {
      bojutsuTechnique: {
        id: `${characterId}:bojutsu:bojutsu-technique`,
        characterId,
        label: {
          EN: "Bojutsu Technique",
          fallback: "Bojutsu Technique",
        },
        notation: [fgcNotation.down, fgcNotation.forward, fgcNotation.three],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:bojutsu`],
        },
        meterGain: 1,
        tags: ["variation", "branch-specific"],
        sourceIds: ["mkwarehouse-mkx", "in-game-practice-mode"],
