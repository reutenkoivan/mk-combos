...
export const alienMoves = {
  sourcePath: "characters/alien.ts",
  characterId,
  ...
  variations: {
    tarkatan: {
      tarkatanTechnique: {
        id: `${characterId}:tarkatan:tarkatan-technique`,
        characterId,
        label: {
          EN: "Tarkatan Technique",
          fallback: "Tarkatan Technique",
        },
        notation: [fgcNotation.down, fgcNotation.back, fgcNotation.one],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:tarkatan`],
        },
    ...
    acidic: {
      acidicTechnique: {
        id: `${characterId}:acidic:acidic-technique`,
        characterId,
        label: {
          EN: "Acidic Technique",
          fallback: "Acidic Technique",
        },
        notation: [fgcNotation.back, fgcNotation.forward, fgcNotation.two],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:acidic`],
        },
        tags: ["variation", "branch-specific"],
        sourceIds: ["mkwarehouse-mkx", "in-game-practice-mode"],
      },
    ...
    konjurer: {
      konjurerTechnique: {
        id: `${characterId}:konjurer:konjurer-technique`,
        characterId,
        label: {
          EN: "Konjurer Technique",
          fallback: "Konjurer Technique",
        },
        notation: [fgcNotation.down, fgcNotation.forward, fgcNotation.three],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:konjurer`],
        },
        meterGain: 1,
        tags: ["variation", "branch-specific"],
        sourceIds: ["mkwarehouse-mkx", "in-game-practice-mode"],
