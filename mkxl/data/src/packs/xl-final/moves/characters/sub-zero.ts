...
export const subZeroMoves = {
  sourcePath: "characters/sub-zero.ts",
  characterId,
  ...
  variations: {
    grandmaster: {
      grandmasterTechnique: {
        id: `${characterId}:grandmaster:grandmaster-technique`,
        characterId,
        label: {
          EN: "Grandmaster Technique",
          fallback: "Grandmaster Technique",
        },
        notation: [fgcNotation.down, fgcNotation.back, fgcNotation.one],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:grandmaster`],
        },
    ...
    cryomancer: {
      cryomancerTechnique: {
        id: `${characterId}:cryomancer:cryomancer-technique`,
        characterId,
        label: {
          EN: "Cryomancer Technique",
          fallback: "Cryomancer Technique",
        },
        notation: [fgcNotation.back, fgcNotation.forward, fgcNotation.two],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:cryomancer`],
        },
        tags: ["variation", "branch-specific"],
        sourceIds: ["mkwarehouse-mkx", "in-game-practice-mode"],
      },
    ...
    unbreakable: {
      unbreakableTechnique: {
        id: `${characterId}:unbreakable:unbreakable-technique`,
        characterId,
        label: {
          EN: "Unbreakable Technique",
          fallback: "Unbreakable Technique",
        },
        notation: [fgcNotation.down, fgcNotation.forward, fgcNotation.three],
        category: "variation",
        availability: {
          kind: "variation",
          variationIds: [`${characterId}:unbreakable`],
        },
        meterGain: 1,
        tags: ["variation", "branch-specific"],
        sourceIds: ["mkwarehouse-mkx", "in-game-practice-mode"],
